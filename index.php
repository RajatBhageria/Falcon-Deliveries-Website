	...
	<section class="banner" role="banner">
        <header id="header">
            <div class="header-content clearfix">
                <a class="logo" href="#"><img src="images/Falcon-Logo-White.png" alt=""></a>
        ...
        <div class="container">
            <div class="col-md-10 col-md-offset-1">
                <div class="banner-text text-center">
                    <h1>We're inventing the future of delivery</h1>
                    <p>Our last-mile robots will deliver your ice cream, diet coke, toothpaste, Chipotle burrito, or Starbucks coffee by air or by sidewalk in less than 10 minutes for less than a dollar.</p>
                    <a href="#" class="btn btn-large">I want to join the revolution!</a>
                </div><!-- banner text -->
            </div>
        </div>
    </section><!-- banner -->
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 feature text-center">
                    ...
                    <div class="feature-content">
                        <h5>Simple</h5>
                        <p>All students need to do is open up to the Falcon app, select what they want, and then track the drone on their screen as it delivers to them.</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 feature text-center">
                    <span class="icon icon-desktop"></span>
                    <div class="feature-content">
                        <h5>Bye Bye CVS, Wawa, and Take-Out</h5>
                        <p>Don't go out in the cold to get a can of coke or your scone. We'll bring anything you need from nearby resturants, cafes, or convenient stores.</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 feature text-center">
                    <span class="icon icon-lightbulb"></span>
                    <div class="feature-content">
                        <h5>Fast and Cheap</h5>
                        <p>Unlike Postmates, Grubhub, or goPuff, we fulfill your needs in less than 10 minutes for less than a $1 delivery charge. What could be better than that? </p>
                    </div>
                </div>
                <!--
                <div class="col-md-4 col-sm-6 feature text-center">
                    ...
                    <div class="feature-content">
                        <h5>Nearby</h5>
                        <p>We're not competing with other companies </p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 feature text-center">
...
-->
    <footer class="footer">
            ...
            <div class="container">
                <div class="row">
                    <div class="footer-col col-md-4">
                        <h5>Location</h5>
                        <p>Silicon Valley and Philadelphia</p>
                    </div>
                    <div class="footer-col col-md-4">
                        <!--
                        <h5>About Falcon</h5>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="col-md-12">
                    <p>Copyright © 2016 Falcon Technologies, Inc. All Rights Reserved<br>Made with <i class="fa fa-heart pulse"></i> by Falcon</p>
                </div>
            </div>
        </div>
    </footer><!-- footer -->
